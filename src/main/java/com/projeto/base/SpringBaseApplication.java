...
public class SpringBaseApplication {
	...
	public void LoadDatabase () {
		...
		//Account
		Account acc = new Account(u1);
		Account ac2 = new Account(u6);
		Account ac3 = new Account(u2);
		Account ac4 = new Account(u3);
		Account ac5 = new Account(u4);
		Account ac6 = new Account(u5);
		
		List<Account> la = Arrays.asList(acc,ac2,ac3,ac4,ac5,ac6);
		
		
		userRepopsitory.saveAll(ls);
		servAcc.saveAll(srvlist);
		accountRepository.saveAll(la);
